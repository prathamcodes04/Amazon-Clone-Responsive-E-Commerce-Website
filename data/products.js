...
//here clothing is inheriting properties and methods of product class
...
const obj3 = {
  method: () => {
    console.log(this); //same value as outside arrow function
  }
};
obj3.method();
*/
...
export function loadProducts(fun) {
  //call fun after loading all products
